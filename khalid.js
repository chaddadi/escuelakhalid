...
function end(num1,num2,num3){
    title.innerHTML = `${squares[num1]} winner`;
        document.getElementById('item'+num1).style.background = '#00f';
        document.getElementById('item'+num2).style.background = '#00f';
        document.getElementById('item'+num3).style.background = '#00f';
